...
describe('oldParamParser', () => {
  before(() => {
    fetchMock.get(
      'begin:https://api.digitransit.fi/geocoding/v1/search?digitransit-subscription-key=undefined&text=lapinlahdenkatu',
      resFrom,
    );
    fetchMock.get(
      'begin:https://api.digitransit.fi/geocoding/v1/search?digitransit-subscription-key=undefined&text=koivikkotie',
      resTo,
    );
  });
